...
int main(int argc, char *argv[])
{
  ...
  // Verifica se o nº de argumentos é correto
  if (argc != 2 && argc != 3)
  {
  ...
  // Se houver 3 argumentos abre o 2º ficheiro
  // usar dup2 para passar o stdout_fileno para o ficheiro em argv[2]
  // dup2(fd, STDOUT_FILENO); qualquer escrita em STDOUT_FILENO, neste programa, passa a ser feita no ficheiro representado pelo descritor fd.
  if (argc == 3)
  {
